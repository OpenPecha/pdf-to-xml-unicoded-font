...
| Document | Contents |
|----------|----------|
| [README.md](../README.md) | Installation from [OpenPecha/pdf-cmap-fix](https://github.com/OpenPecha/pdf-cmap-fix) (`pip install git+…`), CLI, Python API, bundled database provenance |
| [approach.md](approach.md) | How ToUnicode patching and font matching work |
